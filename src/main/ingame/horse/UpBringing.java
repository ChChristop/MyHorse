...
public class UpBringing implements A {
	...
	public void swtichJobs(MyHorse h) {
		...
		switch(a) {
			case 1: 
				h.setRaceType("도주마");
				System.out.println("________________________도주마로 전직하였습니다!_______________________________");
				break;
			case 2: 
				h.setRaceType("선행마");
				System.out.println("________________________선행마로 전직하였습니다!_______________________________");
				break;
			case 3: 
				h.setRaceType("주입마");
				System.out.println("________________________주입마로 전직하였습니다!_______________________________");
				break;
			case 4: 
				h.setRaceType("자유마");
				System.out.println("________________________자유마로 전직하였습니다!_______________________________");
				break;		
		}	
	}
